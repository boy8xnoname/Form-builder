 ...
 */
class EP_Mondula_Form_Wizard_Block_Get_Variable extends EP_Mondula_Form_Wizard_Block {
	...
	public static function from_aa($aa , $current_version, $serialized_version) {
		...
		return new EP_Mondula_Form_Wizard_Block_Get_Variable($label, $get_param);
	}

	public static function addType($types) {

		$types['get-variable'] = array(
			'class' => 'EP_Mondula_Form_Wizard_Block_Get_Variable',
...
add_filter('multi-step-form/block-types', 'EP_Mondula_Form_Wizard_Block_Get_Variable::addType', 20);
