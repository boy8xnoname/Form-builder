 ...
 * @author alex
 */
class EP_Mondula_Form_Wizard_Block_Paragraph extends EP_Mondula_Form_Wizard_Block {
	...
	public static function from_aa($aa , $current_version, $serialized_version) {
		$text = $aa['text'];
		return new EP_Mondula_Form_Wizard_Block_Paragraph($text);
	}
	...
	public static function addType($types) {
		...
		$types['paragraph'] = array(
			'class' => 'EP_Mondula_Form_Wizard_Block_Paragraph',
...
add_filter('multi-step-form/block-types', 'EP_Mondula_Form_Wizard_Block_Paragraph::addType', 8);
