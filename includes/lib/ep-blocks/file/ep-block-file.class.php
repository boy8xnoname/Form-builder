 ...
 * @author alex
 */
class EP_Mondula_Form_Wizard_Block_File extends EP_Mondula_Form_Wizard_Block {
	...
	public function render($ids) {
	  ...
	  ?>
		<div class="fw-step-block fw-step-icon-<?php echo $showFieldIcon;?> <?php if($this->_fullwidth == 'true') {echo 'block-fullWidth';} else { echo 'block-halfWidth'; }?>" data-blockId="<?php echo $ids[0]; ?>" data-type="fw-file" data-required="<?php echo $this->_required; ?>">
			<div class="fw-input-container">
				...
				<label class="fw-btn fw-button-fileupload" for="<?php echo $group ?>">
					<i class="fa fa-upload fw-file-upload-status" aria-hidden="true"></i>
				<span><?php _e('Choose a file', 'multi-step-form') ?></span></label>
	...
	public static function from_aa($aa , $current_version, $serialized_version) {
		...
		return new EP_Mondula_Form_Wizard_Block_File($label, $required, $multi);
	}

	public static function addType($types) {

		$types['file'] = array(
			'class' => 'EP_Mondula_Form_Wizard_Block_File',
...
add_filter('multi-step-form/block-types', 'EP_Mondula_Form_Wizard_Block_File::addType', 6);
