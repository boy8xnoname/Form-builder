 ...
 * @author alex
 */
class EP_Mondula_Form_Wizard_Block_Media extends EP_Mondula_Form_Wizard_Block {
	...
	public static function from_aa($aa , $current_version, $serialized_version) {
		...
		return new EP_Mondula_Form_Wizard_Block_Media($attachmentId);
	}

	public static function addType($types) {

		$types['media'] = array(
			'class' => 'EP_Mondula_Form_Wizard_Block_Media',
...
add_filter('multi-step-form/block-types', 'EP_Mondula_Form_Wizard_Block_Media::addType', 9);
