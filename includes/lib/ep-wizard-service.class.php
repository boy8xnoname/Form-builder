...
class EP_Mondula_Form_Wizard_Wizard_Service {
	...
	public function __construct(EP_Mondula_Form_Wizard_Wizard_Repository $repository, $plugin_version) {
	...
	public function get_by_id($id) {
		...
		if ($row)
		{
			return EP_Mondula_Form_Wizard_Wizard::from_aa(json_decode($row->json, true), $this->_plugin_version, $row->version);
		} else {
			return null;
		}
	}
