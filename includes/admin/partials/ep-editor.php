<?php
    ...
    $block_types = EP_Mondula_Form_Wizard_Block::get_block_types();
?>
...
<div class="wrap">
    <h2 class="nav-tab-wrapper">
        <a class="nav-tab nav-tab-active" id="fw-nav-steps"><?php _e('Steps(Maximun 10 steps)', 'multi-step-form'); ?></a>
        <a class="nav-tab" id="fw-nav-settings"><?php _e('Form settings (Setup action for Form)', 'multi-step-form'); ?></a>
        <a class="nav-tab" id="fw-nav-thankyou-page"><?php _e('Setup Thank You page', 'multi-step-form'); ?></a>
    </h2>

    <div id="fw-thankyou-settings-container" class="fw-thankyou-settings-container" style="display:none;">
        <div class="wrap">
            <h1><?php _e('General settings', 'multi-step-form'); ?></h1>
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php _e('Select Thank You page Action', 'multi-step-form'); ?></th>
                    <td>
                        <select class="fw-thankyou-page-action">
                            <option value="show-thankyou-message" selected>Show Thank You Message</option>
                            <option value="redirect-new-page">Redirect to New page</option>
                            <option value="keep-current">Keep on current page</option>
                        </select>
                    </td>
                </tr>
                <tr class="thankyou-message-wrap" valign="top">
                    <th scope="row"><?php _e('Thank You Page Heading', 'multi-step-form'); ?></th>
                    <td>
                        <input type="text" id="fw-thankyou-heading" class="fw-thankyou-heading" />
                    </td>
                </tr>
                <tr class="thankyou-message-wrap" valign="top">
                    <th scope="row"><?php _e('Thank You Page Description', 'multi-step-form'); ?></th>
                    <td>
                        <textarea name="fw-thankyou-description" class="fw-thankyou-description"></textarea>    
                    </td>
                </tr>
                <tr class="thankyou-message-wrap" valign="top">
                    <th scope="row"><?php _e('Button title', 'multi-step-form'); ?></th>
                    <td>
                        <input type="text" name="fw-thankyou-button-heading" class="fw-thankyou-button-heading" />
                    </td>
                </tr>

                <tr class="redirect-thankyou-page-wrap"  valign="top" style="display: none">
    ...
    <div id="fw-mail-settings-container" class="fw-mail-settings-container" style="display:none;">
        <div class="wrap">
            <h1><?php _e('Form settings', 'multi-step-form'); ?></h1>
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php _e('Button Submit Title:', 'multi-step-form'); ?></th>
                    <td>
                        <input type="text" class="fw-button-submit-title" placeholder="Submit title. Leave this empty for use default" />
                        <p class="description"><?php _e('This button for title of button submit on multi step form. Leave this empty for use default', 'multi-step-form'); ?></p>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Button Back Title:', 'multi-step-form'); ?></th>
                    <td>
                        <input type="text" class="fw-button-back-title" placeholder="Back title. Leave this empty for use default" />
                        <p class="description"><?php _e('This button for title of button Back on multi step form. Leave this empty for use default', 'multi-step-form'); ?></p>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Button Next Title:', 'multi-step-form'); ?></th>
                    <td>
                        <input type="text" class="fw-button-next-title" placeholder="Next title. Leave this empty for use default" />
                        <p class="description"><?php _e('This button for title of button Next on multi step form. Leave this empty for use default', 'multi-step-form'); ?></p>
                    </td>
                </tr>
            </table>
            ...
            <table class="form-table">
                ...
                >
                    ...
                    <td>
                        ...
                        <p class="description ep-warn"><?php _e('This is a beta function. Please be aware that there may occur problems.', 'multi-step-form'); ?></p>
                        ...
                        <p class="description ep-warn"><?php _e('Make sure that the e-mail field has the required flag set. If not, the user may send the form without filling out the required email field. This causes an error, as no opt-in request can be send.', 'multi-step-form'); ?></p>
                        <p class="description ep-warn"><?php _e('This feature currently does NOT work with registration and file upload fields.', 'multi-step-form'); ?></p>
                    </td>
                </tr>
                <tr valign="top"
                <?php if (!is_plugin_active('multi-step-form-plus/multi-step-form-plus.php')) { echo 'style="display: none;"'; } ?>
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <p class="description ep-warn"><?php _e('WARNING: only enter custom email headers if you know what you\'re doing - it can break your form.', 'multi-step-form'); ?></p>
                        <p class="description ep-warn"><?php _e('These settings may cause more problems on Windows Servers.', 'multi-step-form'); ?></p>
                    </td>
                </tr>
                <tr valign="top">
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <p class="description ep-warn"><?php _e('Please make sure there is only one field with that label. Also make sure you have written it here exactly as in the form, including case.', 'multi-step-form'); ?></p>
                        <p class="description ep-warn"><?php _e('If you want to use the { sign without a replacement, use \{. This will be reduced to one { sign.', 'multi-step-form'); ?></p>
                        <p class="description ep-warn"><?php _e('If the field is not required and the user enters nothin, the replacement will just disappear without new content.', 'multi-step-form'); ?></p>
                    </td>
                </tr>
            </table>
            <button class="fw-button-save"><?php _e('Save'); ?></button>
