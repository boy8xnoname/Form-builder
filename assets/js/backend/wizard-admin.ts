...
(function ($) {
	...
	function renderRadio(radio) {
		...
		// Add tooltip
		radioHtml += '<label>' + wizard.i18n.labeltooltip + '</label>';
		if (radio.tooltipcontent == undefined || radio.tooltipcontent === "") {
			radioHtml += '<input type="text" class="fw-radio-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value=""/><br/>';
		} else {
			radioHtml += '<input type="text" class="fw-radio-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value="' + radio.tooltipcontent + '"/><br/>';
		}	
		...
		radioHtml += '<label><input type="checkbox" class="fw-fullwidth"' + isChecked(radio.fullwidth) + '/> ' + wizard.i18n.fullwidth + '</label>';
		return radioHtml;
	}
	...
	function renderSelect(select) {
		...
		selectHtml += '<label>' + wizard.i18n.labelplaceholder + '</label>';
		if (select.placeholder == undefined || select.placeholder === "") {
			selectHtml += '<input type="text" class="fw-select-placeholder" placeholder="' + wizard.i18n.select.placeholder + '" value=""/><br/>';
		} else {
			selectHtml += '<input type="text" class="fw-select-placeholder" placeholder="' +wizard.i18n.select.placeholder + '" value="' + select.placeholder + '"/><br/>';
		}

		// Add tooltip
		selectHtml += '<label>' + wizard.i18n.labeltooltip + '</label>';
		if (select.tooltipcontent == undefined || select.tooltipcontent === "") {
			selectHtml += '<input type="text" class="fw-select-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value=""/><br/>';
		} else {
			selectHtml += '<input type="text" class="fw-select-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value="' + select.tooltipcontent + '"/><br/>';
		}	
		...
		selectHtml += '<label><input type="checkbox" class="fw-fullwidth"' + isChecked(select.fullwidth) + '/> ' + wizard.i18n.fullwidth + '</label>';
		return selectHtml;
	}
	...
	function renderCheckbox(block) {
		...
		textHtml += '<input type="text" class="fw-text-label fw-block-label" placeholder="' + wizard.i18n.label + '" value="' + block.label + '"/><br/>';
	...
	function renderTextInput(block) {
		...
		textHtml += '<label>' + wizard.i18n.label + '</label>';
		textHtml += '<input type="text" class="fw-text-label fw-block-label" placeholder="' + wizard.i18n.label + '" value="' + block.label + '"/><br/>';
		textHtml += '<label>' + wizard.i18n.labelplaceholder + '</label>';
		if (block.placeholder == undefined || block.placeholder === "") {
			textHtml += '<input type="text" class="fw-text-placeholder" placeholder="' + wizard.i18n.labelplaceholder + '" value=""/><br/>';
		} else {
			textHtml += '<input type="text" class="fw-text-placeholder" placeholder="' + wizard.i18n.labelplaceholder + '" value="' + block.placeholder + '"/><br/>';
		}
		// Add tooltip
		textHtml += '<label>' + wizard.i18n.labeltooltip + '</label>';
		if (block.tooltipcontent == undefined || block.tooltipcontent === "") {
			textHtml += '<input type="text" class="fw-text-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value=""/><br/>';
		} else {
			textHtml += '<input type="text" class="fw-text-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value="' + block.tooltipcontent + '"/><br/>';
		}	

		textHtml += '<label><input type="checkbox" class="fw-required"' + isChecked(block.required) + '/>' + wizard.i18n.required + '</label>';
		textHtml += '<label><input type="checkbox" class="fw-fullwidth"' + isChecked(block.fullwidth) + '/> ' + wizard.i18n.fullwidth + '</label>';
		return textHtml;
	}
	...
	function renderEmail(block) {
		...
		emailHtml += '<input type="text" class="fw-text-label fw-block-label" placeholder="' + wizard.i18n.label + '" value="' + block.label + '"/><br/>';
		emailHtml += '<label>' + wizard.i18n.labelplaceholder + '</label>';
		if (block.placeholder == undefined || block.placeholder === "") {
			emailHtml += '<input type="text" class="fw-email-placeholder" placeholder="' + wizard.i18n.labelplaceholder + '" value=""/><br/>';
		} else {
			emailHtml += '<input type="text" class="fw-email-placeholder" placeholder="' + wizard.i18n.labelplaceholder + '" value="' + block.placeholder + '"/><br/>';
		}
		// Add tooltip
		emailHtml += '<label>' + wizard.i18n.labeltooltip + '</label>';
		if (block.tooltipcontent == undefined || block.tooltipcontent === "") {
			emailHtml += '<input type="text" class="fw-email-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value=""/><br/>';
		} else {
			emailHtml += '<input type="text" class="fw-email-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value="' + block.tooltipcontent + '"/><br/>';
		}	

		emailHtml += '<label><input type="checkbox" class="fw-required"' + isChecked(block.required) + '/>' + wizard.i18n.required + '</label>';
		emailHtml += '<label><input type="checkbox" class="fw-fullwidth"' + isChecked(block.fullwidth) + '/> ' + wizard.i18n.fullwidth + '</label>';
		return emailHtml;
	}
	...
	function renderNumeric(block) {
		...
		numericHtml += '<label>' + wizard.i18n.labelplaceholder + '</label>';
		if (block.placeholder == undefined || block.placeholder === "") {
			numericHtml += '<input type="text" class="fw-num-placeholder" placeholder="' + wizard.i18n.labelplaceholder + '" value=""/><br/>';
		} else {
			numericHtml += '<input type="text" class="fw-num-placeholder" placeholder="' + wizard.i18n.labelplaceholder + '" value="' + block.placeholder + '"/><br/>';
		}
		// Add tooltip
		numericHtml += '<label>' + wizard.i18n.labeltooltip + '</label>';
		if (block.tooltipcontent == undefined || block.tooltipcontent === "") {
			numericHtml += '<input type="text" class="fw-num-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value=""/><br/>';
		} else {
			numericHtml += '<input type="text" class="fw-num-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value="' + block.tooltipcontent + '"/><br/>';
		}	
		...
		numericHtml += '<label><input type="checkbox" class="fw-fullwidth"' + isChecked(block.fullwidth) + '/> ' + wizard.i18n.fullwidth + '</label>';
		return numericHtml;
	}
	...
	function renderFile(block) {
		...
		fileHtml += '<label><input type="checkbox" class="fw-fullwidth"' + isChecked(block.fullwidth) + '/> ' + wizard.i18n.fullwidth + '</label>';
		return fileHtml;
	}
	...
	function renderDate(block) {
		...
		// Add tooltip
		dateHtml += '<label>' + wizard.i18n.labeltooltip + '</label>';
		if (block.tooltipcontent == undefined || block.tooltipcontent === "") {
			dateHtml += '<input type="text" class="fw-date-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value=""/><br/>';
		} else {
			dateHtml += '<input type="text" class="fw-date-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value="' + block.tooltipcontent + '"/><br/>';
		}
		dateHtml += '<label><input type="checkbox" class="fw-required"' + isChecked(block.required) + '/>' + wizard.i18n.required + '</label>';
		dateHtml += '<label><input type="checkbox" class="fw-fullwidth"' + isChecked(block.fullwidth) + '/> ' + wizard.i18n.fullwidth + '</label>';
		return dateHtml;
	}
	...
	function renderTextArea(block) {
		...
		textAreaHtml += '<label>' + wizard.i18n.labelplaceholder + '</label>';

		if (block.placeholder == undefined || block.placeholder === "") {
			textAreaHtml += '<input type="text" class="fw-textarea-placeholder" placeholder="' + wizard.i18n.labelplaceholder + '" value=""/><br/>';
		} else {
			textAreaHtml += '<input type="text" class="fw-textarea-placeholder" placeholder="' + wizard.i18n.labelplaceholder + '" value="' + block.placeholder + '"/><br/>';
		}

		// Add tooltip
		textAreaHtml += '<label>' + wizard.i18n.labeltooltip + '</label>';
		if (block.tooltipcontent == undefined || block.tooltipcontent === "") {
			textAreaHtml += '<input type="text" class="fw-textarea-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value=""/><br/>';
		} else {
			textAreaHtml += '<input type="text" class="fw-textarea-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value="' + block.tooltipcontent + '"/><br/>';
		}	


		textAreaHtml += '<label><input type="checkbox" class="fw-required"' + isChecked(block.required) + '/>' + wizard.i18n.required + '</label>';
		textAreaHtml += '<label><input type="checkbox" class="fw-fullwidth"' + isChecked(block.fullwidth) + '/> ' + wizard.i18n.fullwidth + '</label>';
		return textAreaHtml;
	}
	...
	function renderAgree(block) {
		var blockAgreeHtml = '';	
		blockAgreeHtml += '<label>' + wizard.i18n.label + '</label>';
		blockAgreeHtml += '<input type="text" class="fw-agree-label" placeholder="' + wizard.i18n.label + '" value="' + block.label + '"/><br/>';

		blockAgreeHtml += '<div class="fw-agree-container">';
		blockAgreeHtml += '<label>Agree Content</label>';
		blockAgreeHtml += '<textarea class="fw-agree-content fw-block-label"  placeholder="' + wizard.i18n.labelplaceholder + '">' +  block.agreecontent  + '</textarea>';
		blockAgreeHtml += '</div>';	
	
		// Add tooltip
		blockAgreeHtml += '<label>' + wizard.i18n.labeltooltip + '</label>';
		if (block.tooltipcontent == undefined || block.tooltipcontent === "") {
			blockAgreeHtml += '<input type="text" class="fw-agree-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value=""/><br/>';
		} else {
			blockAgreeHtml += '<input type="text" class="fw-agree-tooltip" placeholder="' + wizard.i18n.labeltooltip + '" value="' + block.tooltipcontent + '"/><br/>';
		}	
		blockAgreeHtml += '<label><input type="checkbox" class="fw-required"' + isChecked(block.required) + '/> ' + wizard.i18n.required + '</label>';
		return blockAgreeHtml;
	}
	...
	function renderRegex(block) {
		...
		regexHtml += '<label><input type="checkbox" class="fw-fullwidth"' + isChecked(block.fullwidth) + ' checked/> ' + wizard.i18n.fullwidth + '</label>';
		return regexHtml;
	}
	...
	function renderBlocks(blocks) {
		...
		for (let i = 0; i < blockCount; i++) {
			if (blocks[i].type == 'conditional') {
				...
				blocksHtml += '<input class="ep-block-meta" name="ep-block-meta-' + i + '" type="hidden" value="' + encodeURI(JSON.stringify(conditionalSettings)) + '">';
				blocksHtml += '</div>';
			} else {
	...
	function renderPart(part, partClass) {
		...
		// title
		partHtml += '<input type="text" class="fw-part-title" value="' + part.title + '" placeholder="' + wizard.i18n.partTitle + '"/>';
		...
		partHtml += '</div>';
		partHtml += '<div class="element-layout-setup" style="display: flex">';
			partHtml += '<div class="section-setting-column ">';
				// console.log(part);
				partHtml += '<select class="section-setting-column">';
					partHtml += '<option value="one-column" ' + isSelected('one-column', part.settingColumn) + '>Layout 1 column</option>';
					partHtml += '<option value="two-column" ' + isSelected('two-column', part.settingColumn) + '>Layout 2 column (by Flex css)</option>';
					partHtml += '<option value="three-column" ' + isSelected('three-column', part.settingColumn) + '>Layout 3 column (by Flex css)</option>';
				partHtml += '</select>';

				partHtml += '<select class="flex-direction-column">';
					partHtml += '<option value="row" ' + isSelected('row', part.directionColumn) + '>Flex-direction: row</option>';
					partHtml += '<option value="row-reverse" ' + isSelected('row-reverse', part.directionColumn) + '>Flex-direction: row-reverse</option>';
					partHtml += '<option value="column" ' + isSelected('column', part.directionColumn) + '>Flex-direction: column</option>';
					partHtml += '<option value="column-reverse" ' + isSelected('column-reverse', part.directionColumn) + '>Flex-direction: column-reverse</option>';
				partHtml += '</select>';
			partHtml += '</div>';
			

			partHtml += '<div class="section-setting-column element-class-or-id" style="width: 50%">';

				if (part.customID === undefined || part.customID === "") {
					partHtml += '<input type="text" class="fw-part-customID"  placeholder="' + wizard.i18n.partIDTitle + '"/>';
				} else {
					partHtml += '<input type="text" class="fw-part-customID" value="' + part.customID + '" placeholder="' + wizard.i18n.partIDTitle + '"/>';
				}

				if (part.customClass !== undefined || part.customClass === "") {
					partHtml += '<input type="text" class="fw-part-customClass"  value="' + part.customClass + '"  placeholder="' + wizard.i18n.partClassTitle + '"/>';
				} else {
					partHtml += '<input type="text" class="fw-part-customClass" placeholder="' + wizard.i18n.partClassTitle + '"/>';				
				}
			partHtml += '</div>';
		partHtml += '</div>';
	...
	function renderFormSettings(formSettings) {
		if (formSettings) {
			if (formSettings.thankyouAction) {
				$('.fw-thankyou-page-action').val(formSettings.thankyouAction);
			}
			// Show hide thank you block
			let thankyouAction = formSettings.thankyouAction
			if(thankyouAction == 'show-thankyou-message') {
				$('.thankyou-message-wrap').show()
				$('.redirect-thankyou-page-wrap').hide()
			} else if(thankyouAction == 'redirect-new-page') {
				$('.thankyou-message-wrap').hide()
				$('.redirect-thankyou-page-wrap').show()
			} else if(thankyouAction == 'keep-current') {
				$('.thankyou-message-wrap').hide()
				$('.redirect-thankyou-page-wrap').hide()
			}	
			// Config thank you
			if (formSettings.thankyouMessageHeadding) {
				$('.fw-thankyou-heading').val(formSettings.thankyouMessageHeadding);
			}
			if (formSettings.thankyouMessageDescription) {
				$('.fw-thankyou-description').val(formSettings.thankyouMessageDescription);
			}
			if (formSettings.thankyouMessageButtonTitle) {
				$('.fw-thankyou-button-heading').val(formSettings.thankyouMessageButtonTitle);
			}
			...
			// Form setting
			if (formSettings.submitTitle) {
				$('.fw-button-submit-title').val(formSettings.submitTitle);
			}
			if (formSettings.backTitle) {
				$('.fw-button-back-title').val(formSettings.backTitle);
			}
			if (formSettings.nextTitle) {
				$('.fw-button-next-title').val(formSettings.nextTitle);
			}
			// Email config setup
	...
	function getRadioData($radio, radio) {
		...
		radio['fullwidth'] = $radio.find('.fw-fullwidth').prop('checked');
		radio['tooltipcontent'] = $radio.find('.fw-radio-tooltip').val();
	}
	...
	function getSelectData($select, select) {
		...
		select['fullwidth'] = $select.find('.fw-fullwidth').prop('checked');
		select['tooltipcontent'] = $select.find('.fw-select-tooltip').val();
	}
	...
	function getCheckboxData($checkbox, checkbox) {
		...
		checkbox['fullwidth'] = $checkbox.find('.fw-fullwidth').prop('checked');
	}

	function getAgreeData($text, text) {
		text['label'] = $text.find('.fw-agree-label').val();
		text['agreecontent'] = $text.find('.fw-agree-content').val();
		text['required'] = $text.find('.fw-required').prop('checked');
		text['tooltipcontent'] = $text.find('.fw-agree-tooltip').val();
	}

	function getTextData($text, text) {
		text['label'] = $text.find('.fw-text-label').val();
		text['placeholder'] = $text.find('.fw-text-placeholder').val();
		text['required'] = $text.find('.fw-required').prop('checked');
		text['fullwidth'] = $text.find('.fw-fullwidth').prop('checked');
		text['tooltipcontent'] = $text.find('.fw-text-tooltip').val();
	}

	function getEmailData($text, text) {
		text['label'] = $text.find('.fw-text-label').val();
		text['placeholder'] = $text.find('.fw-email-placeholder').val();
		text['required'] = $text.find('.fw-required').prop('checked');
		text['fullwidth'] = $text.find('.fw-fullwidth').prop('checked');
		text['tooltipcontent'] = $text.find('.fw-email-tooltip').val();
	}
	...
	function getNumericData($text, text) {
		text['label'] = $text.find('.fw-text-label').val();
		text['placeholder'] = $text.find('.fw-num-placeholder').val();
		text['required'] = $text.find('.fw-required').prop('checked');
		text['minimum'] = $text.find('.fw-numeric-minimum').val();
		text['maximum'] = $text.find('.fw-numeric-maximum').val();
		text['fullwidth'] = $text.find('.fw-fullwidth').prop('checked');
		text['tooltipcontent'] = $text.find('.fw-num-tooltip').val();
	}
	...
	function getDateData($text, text) {
		...
		text['required'] = $text.find('.fw-required').prop('checked');
		text['fullwidth'] = $text.find('.fw-fullwidth').prop('checked');
		text['tooltipcontent'] = $text.find('.fw-date-tooltip').val();
	}

	function getTextareaData($text, text) {
		text['label'] = $text.find('.fw-textarea-label').val();
		text['placeholder'] = $text.find('.fw-textarea-placeholder').val();
		text['required'] = $text.find('.fw-required').prop('checked');
		text['fullwidth'] = $text.find('.fw-fullwidth').prop('checked');
		text['tooltipcontent'] = $text.find('.fw-textarea-tooltip').val();
	}
	...
	function getPartData($part) {
		...
		part['customID'] = $part.find('.fw-part-customID').val();
		part['customClass'] = $part.find('.fw-part-customClass').val();

		part['settingColumn'] = $part.find('select.section-setting-column').val();
		part['directionColumn'] = $part.find('select.flex-direction-column').val();		
	...
	function getSettings() {
		var settings = {
			// General settings
			thankyouAction: $('.fw-thankyou-page-action').val(),
			thankyouMessageHeadding: $('.fw-thankyou-heading').val(),
			thankyouMessageDescription: $('.fw-thankyou-description').val(),
			thankyouMessageButtonTitle: $('.fw-thankyou-button-heading').val(),

			thankyou: $('.fw-settings-thankyou').val(),
			// Form setting
			submitTitle: $('.fw-button-submit-title').val(),
			backTitle: $('.fw-button-back-title').val(),
			nextTitle: $('.fw-button-next-title').val(),
			// Mail settings
			to: $('.fw-mail-to').val(),
	...
	function isSelected(value ,val) {
		var selectedColumnAttr = '';
		if (val === value) {
			selectedColumnAttr = 'selected';
		}
		return selectedColumnAttr;
	}
	...
	function setupThickbox() {
		$(".thickbox").click(function (thickEvent) {
			// AGREE BUTTONS
			$("#fw-thickbox-Agree").unbind('click').click(function (thickRadioEvent) {
				tb_remove();
			...
			// SERVICES
			$("#fw-thickbox-services").unbind('click').click(function () {
				tb_remove();
				var block = $(renderBlock({
					type: 'services',
					attachmentId: 0
	...
	function selectMedia(e) {
		...
		media_frame.on('close', function () {
			const $block = media_frame.ep_block;
	...
	function configThankYou() {
		$(document).on('ready', function(){
			let thankyouVal = $('.fw-thankyou-page-action').val();
			// console.log(thankyouVal);
			if(thankyouVal == 'show-thankyou-message') {
				$('.thankyou-message-wrap').show()
				$('.redirect-thankyou-page-wrap').hide()
			} else if(thankyouVal == 'redirect-new-page') {
				$('.thankyou-message-wrap').hide()
				$('.redirect-thankyou-page-wrap').show()
			} else if(thankyouVal == 'keep-current') {
				$('.thankyou-message-wrap').hide()
				$('.redirect-thankyou-page-wrap').hide()
			}
		});

		$('.fw-thankyou-page-action').on('change', function() {			
			let thankyouVal = $(this).val();
			// console.log(thankyouVal);
			if(thankyouVal == 'show-thankyou-message') {
				$('.thankyou-message-wrap').show()
				$('.redirect-thankyou-page-wrap').hide()
	...
	function run() {
		try {
			...
			$('#fw-nav-settings').on("click", function (e) {
				...
				$('.fw-thankyou-settings-container').hide();
			});
			...
			$('#fw-nav-thankyou-page').on("click", function (e) {
				$(this).addClass('nav-tab-active');
				$(this).siblings().removeClass('nav-tab-active');
				$(container).hide();
				$(elementsContainer).hide();
				$('.fw-thankyou-settings-container').show();
				$('.fw-mail-settings-container').hide();
			});
